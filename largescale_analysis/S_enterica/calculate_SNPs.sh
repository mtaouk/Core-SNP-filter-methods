...
# new temp dir
TMPDIR=/home/taouk/core-genome/Typhi_alignments/test_alignment/tempdir/$dataset
export TMPDIR

# Path to the directory
directory="/home/taouk/core-genome/Typhi_alignments/test_alignments/$dataset"
...
grep -e "input file" -e "output sequence length" A_0.50_raw.txt | sed '/^  input file:/N; s/\n/\t/'